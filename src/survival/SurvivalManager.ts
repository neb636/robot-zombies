...
export class SurvivalManager {
  ...
  /**
   * Advance time. Drains food per partySize, fuel by 1, rolls a random event
   * (40% per day by default). Emits EVENTS.SURVIVAL_TICK.
   *
   * STUB — returns the unchanged state until Stream A fills the body.
   */
